...
export default function AuthPage(){
  ...
  return <main className="shell premiumAppShell">
    <nav className="nav premiumNav">
      <a href={`/${locale}`} className="brandwrap"><div className="brand">mycubacash.com</div><small>{es?'Acceso seguro':'Secure Access'}</small></a>
    ...
    <section className="section" style={{maxWidth:720,margin:'0 auto'}}>
      ...
      <p className="sectionCopy">{es?'Nunca compartas contraseñas ni códigos de acceso. Sofia y el personal de mycubacash no deben pedir tu contraseña.':'Never share one-time codes or passwords. Sofia and mycubacash staff should not ask for your account password.'}</p>
    </section>
  </main>;
}
