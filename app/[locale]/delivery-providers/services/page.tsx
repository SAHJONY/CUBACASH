...
export default function ProviderServices(){
  ...
  return <main className="shell premiumAppShell">
    <nav className="nav premiumNav"><a href={`/${locale}`} className="brandwrap"><div className="brand">MY CUBA CASH</div><small>{es?'Servicios locales':'Local Services'}</small></a><div className="navlinks"><a href={`/${locale}/delivery-providers/manage`}>{es?'Tarifas de entrega':'Delivery rates'}</a><a href={`/${locale}/delivery-providers`}>{es?'Directorio público':'Public directory'}</a></div></nav>
