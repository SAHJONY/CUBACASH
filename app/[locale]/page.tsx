  ...
  return <main className="shell premiumAppShell" dir={rtl?'rtl':'ltr'}>
    ...
    <section className="homeCinematicHero">
      ...
      <div className="homeHeroContent">
        ...
        <p className="heroLead">{es?'mycubacash conecta tu necesidad con proveedores verificados que compiten en disponibilidad, velocidad, cobertura y costo total para darte una mejor opción de cumplimiento local.':'mycubacash connects your need with verified providers that compete on availability, speed, coverage and total cost to give you a better local fulfillment option.'}</p>
    ...
    <footer className="footer premiumFooter"><strong>mycubacash</strong><span><a href={`/${locale}/fees`}>{es?'Tarifas':'Fees'}</a> · <a href={`/${locale}/privacy`}>{es?'Privacidad':'Privacy'}</a> · <a href={`/${locale}/terms`}>{es?'Términos':'Terms'}</a></span><span>{es?'La liquidez local compite por el cliente.':'Local liquidity competes for the customer.'}</span></footer>
  </main>;
}
