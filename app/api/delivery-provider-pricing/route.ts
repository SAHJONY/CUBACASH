...
export async function GET(){
  try{
    ...
    const {data,error}=await supabase.from('delivery_provider_profiles')
      .select('user_id,public_provider_id,display_name,profile_status,public_listing_enabled,pricing_model,fee_currency,base_fee,per_km_fee,minimum_fee,maximum_fee,pricing_notes,pricing_updated_at')
